...
def test_over_2_text_lines_after_signature():
    ...
    assert extracted_signature == None
...
def test_process_marked_lines():
    ...
    assert (list(range(9)), None) == e._process_marked_lines(list(range(9)), 'tesestelt')

    # long line splits signature
    assert (list(range(7)), [7, 8]) == e._process_marked_lines(list(range(9)), 'tsslsless')

    assert (list(range(20)), [20]) == \
        e._process_marked_lines(list(range(21)), 'ttttttstttesllelelets')

    # some signature lines could be identified as text
    assert ([0], list(range(1, 9))) == e._process_marked_lines(list(range(9)), 'tsetetest')
